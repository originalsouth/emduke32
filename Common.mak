...
ifeq ($(EMSCRIPTEN),1)
	...
	EMLINKFLAGS:= -s INITIAL_MEMORY=268435456 -s ALLOW_MEMORY_GROWTH=1 -s ASYNCIFY=1 -s ASYNCIFY_STACK_SIZE=524288 -s STACK_SIZE=5242880 -s EXIT_RUNTIME=0
	ifeq ($(HTML),1)
		EXT=.html
	else
		EXT=.js
